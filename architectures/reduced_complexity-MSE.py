...
Aquest script està basat en NLTC2021112402 v1.0 i en NLTC2022042001 v2.2. Incorpora elements de NLTC2022072502 v1.5.
...
class NLTC202206301_v1_3(tf.keras.Model):
  """Main model class."""
...
def parse_args(argv):
  ...
  parser.add_argument(
      "--model_path", default="NLTC202206301_v1_3",
