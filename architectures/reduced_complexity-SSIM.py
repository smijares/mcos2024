...
# -*- coding: utf-8 -*-
"""
MCOS2023 fixed-rate architecture for SSIM
V1.0
...
class NLTC202206305_v1_0(tf.keras.Model):
  """Main model class."""
...
def parse_args(argv):
  ...
  parser.add_argument(
      "--model_path", default="NLTC202206305_v1_0",
  ...
  train_cmd.add_argument(
      "--train_path", default="/tmp/NLTC202206305_v1_0",
