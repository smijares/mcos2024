...
# -*- coding: utf-8 -*-
"""
Ballé 2018 architecture with range-adaptive normalisation for MSE
V1.0
Sebastià Mijares i Verdú - GICI, UAB
sebastia.mijares@uab.cat

Script to train and run compression models with a fixed rate-distortion tradeoff, optimised for MSE.
